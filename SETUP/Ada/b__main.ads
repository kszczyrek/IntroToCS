...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_template" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#dc920b86#;
   pragma Export (C, u00001, "templateB");
   ...
   u00133 : constant Version_32 := 16#1982dcd0#;
